package edu.personal.dam.tema5.listaEnlazada.listaSimple;
...
public interface Lista {
	 ...
	 * @return la info del primer elemento o null si no lo encuentra.
	 */
	public Persona getFirst();
	
	/**
	 * Obtiene el último elemento de la lista
	 * @return la información del último elemento de la lista o null si no lo encuentra.
	 */
