...
public class MainCuenta {
	public static void main(String[] args) {
		...
		CuentaDeCredito cc1 = new CuentaDeCredito(196.15, "Rubén", "565989546F", "€", 100);
		CuentaDeCredito cc2 = new CuentaDeCredito(2656.45, "Marcos", "56464655D", "€", 100);
